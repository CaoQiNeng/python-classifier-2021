...
def training_code(data_directory, model_directory):
    ...
    # 4 lead
    train_model(model_directory, train_header_files, vaild_header_files, four_leads)
...
######################## batch_size ############################
    ...
    while iter < num_iters:
        ...
        for t, (input, truth, infor) in enumerate(train_loader):
            ...
            # sio.savemat('Valid_recall.mat', {'Valid_recall': Valid_recall})
            ...
            input = input.cuda()
            truth = truth.cuda()
            # input = input  #modify==lym/
            # truth = truth  #modify==lym
            ...
            # sio.savemat('Train_recall.mat', {'Train_recall': Train_recall})
